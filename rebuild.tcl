...
#
# Generated by Vivado on Thu Jan 21 09:34:03 CET 2021
...
#    "/home/paul/work/fpga/Xilinx/artix7/Minimig_ECS_AARS2/cons/aars_v4.0_lite/timing.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/cons/aars_v4.0_lite/timing.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/cons/aars_v4.0_lite/timing.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets AARS_V4.0] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "library" -value "work" -objects $file_obj
